Feature: Pruebas ghost
  @user1 @web
  Scenario: Modificar url de twitter con un username valido - exitoso
    ...
    And I wait for 1 seconds
    Then I see that the new url twitter is correct <message>

    Examples:
        |url                      | message                  | website      |
        |twitter                  | URL of your X profile    |google.com    |