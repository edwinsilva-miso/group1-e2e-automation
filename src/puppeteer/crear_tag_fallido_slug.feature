Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Creacion de tag Fallido (Slug demasiado largo)
    ...
    And I add a tag slug more than 250 characters
    And I click save
    And I take a screenshot
    Then I see the slug input has a notification error saying the slug is too long