Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Crear Tag Metadata fallido (Nombre meta demasiado largo)
    ...
    And I add a meta title more than 300 characters
    And I add a meta description
    And I add a canonical url
    And I click save
    And I take a screenshot
    Then I see the meta title has a notification error regarding the lenght