Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Crear Tag X Fallido (Nombre tag x demasiado Largo)
    ...
    And I add a twitter title more than 300 characters
    And I add a twitter description
    And I click save
    And I take a screenshot
    Then I see the twitter name has a notification error regarding the lenght