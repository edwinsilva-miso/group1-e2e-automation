Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Crear Tag Metadata fallido (Url meta formato incorrecto)
    ...
    And I add a canonical url (random word)
    And I click save
    And I take a screenshot
    Then I see the meta canonical url has a notification error regarding wrong formatting