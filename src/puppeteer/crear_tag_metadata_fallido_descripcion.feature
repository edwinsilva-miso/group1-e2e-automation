Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Crear Tag Metadata fallido (descipcion meta demasiado largo)
    ...
    And I add a meta description more than 500 characters
    And I add a canonical url
    And I click save
    And I take a screenshot
    Then I see the meta description has a notification error regarding the lenght