Feature: Pruebas ghost
  ...
  @user1 @web
  Scenario: Creacion de tag Fallido (titulo demasiado largo)
    ...
    And I click new tag
    And I wait for 7 seconds
    And I add a tag name more than 125 characters
    And I add a tag accentColor
    And I add a tag description
    And I click save
    And I take a screenshot
    Then I see the name input has a notification error saying the name is too long